...
public class LaunchSimu {
    ...
    public static void main(String... args) {
        ...
        for(int i=0; i<2; i++) {
            agents.append("user~").append(i).append(":issia23.agents.UserAgent;");
        }
        for(int i=0; i<5; i++) {
            agents.append("repairCoffee~").append(i).append(":issia23.agents.RepairCoffeeAgent;");
        }
        for(int i=0; i<4; i++) {
            agents.append("partStore~").append(i).append(":issia23.agents.PartStoreAgent;");
        }
        // Ajout des distributeurs
        for(int i=0; i<3; i++) {
            agents.append("distributor~").append(i).append(":issia23.agents.DistributorAgent;");
        }
